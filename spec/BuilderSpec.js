describe("Builder", function () {
  ...
  describe("#build", function () {
    ...
    it("should call appropriate build function", function () {
      ...
      builder.build(cursor);
      expect(builder.buildSnow).toHaveBeenCalledWith(cursor.getPosition());
      builder.buildSnow.reset();
  ...
  describe("build functions", function () {
    ...
    it("#buildSnow", function () {
      var parts = builder.buildSnow(new Point(2, 3));
      var snow = parts[0];
      expect(snow instanceof Snow).toBeTruthy();
      expect(snow.getPosition()).toEqual(new Point(2, 3))
    });
  });
});
