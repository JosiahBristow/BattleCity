describe("PowerUpHandler", function () {
  ...
  describe("#handle", function () {
    ...
    it("tank", function () {
      ...
      powerUp.setPlayerTank(player);
      handler.handle(powerUp);
      expect(handler.handleTank).toHaveBeenCalledWith(player);
    });
  });
  ...
  it("#handleTank", function () {
    ...
    var handler = new PowerUpHandler(eventManager);
    var player = new Tank(eventManager);
    handler.handleTank(player);
    expect(eventManager.fireEvent).toHaveBeenCalledWith({'name': PowerUpHandler.Event.TANK, 'tank': player});
  });
});
