...
Builder.Structure.SNOW = 'Builder.Structure.SNOW';
...
Builder.prototype.build = function (cursor) {
  ...
  else if (this._structure == Builder.Structure.SNOW) {
    structure = this.buildSnow(cursor.getPosition());
  }
...
Builder.prototype.buildSnow = function (position) {
  var parts = [];
  var snow = new Snow(this._eventManager);
